...
- `CHIP_TYPE`: The chip type of the target.
...
**Note**:
- If the ESP32-C3 was previously Wi-Fi provisioned, and you are on a
...
1. In the navigation pane of the AWS IoT console, choose 'Remote actions', and then choose 'Jobs'.
   Choose 'Create a job'.
